...
var listStory = function(req, res) {
    console.log('/changenotice/liststory 패스 요청됨.');
...
var insertStory = function(req, res) {
    console.log('/changenotice/insertstory 패스 요청됨.');
...
var updateStory = function(req, res) {
    console.log('/changenotice/updatestory 패스 요청됨.');
...
var updateViewCount = function(req, res) {
    console.log('/changenotice/updateViewCount 요청됨.');
...
var deleteStory = function(req, res) {
    console.log('/changenotice/deletestory 패스 요청됨.');
