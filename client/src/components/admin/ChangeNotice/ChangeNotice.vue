<template>
    <main>
        <div class="container">
            ...
            <ChangeNoticeTable :stories="storyList"></ChangeNoticeTable>
            ...
            <p class="tar">
                <button @click="writeStory" class="btn btn-basic">시스템변경사항등록</button>
            </p>
            <ChangeNoticeModal v-if="showModal" :storyinfo="storyinfo" :gubun="modalgubun"></ChangeNoticeModal>
        </div>
    </main>
</template>
<script>
...
import ChangeNoticeTable from "./ChangeNoticeTable.vue"
import ChangeNoticeModal from "./ChangeNoticeModal.vue"
...
export default {
        ...
        components: {
            ChangeNoticeTable : ChangeNoticeTable,
        ...
        created: function() {
            this.$EventBus.$on('changeInsertStory' , this.insertStory);
            this.$EventBus.$on('changeUpdateStory' , this.updateStory);
            this.$EventBus.$on('changeDeleteStory' , this.deleteStory);
            this.$EventBus.$on('changeCloseStory'  , this.closeStory );
            this.$EventBus.$on('changeShowStory'   , this.showStory  );
            this.$EventBus.$on('changeSearchStory' , this.searchStory);
        },
        beforeDestroy() {
            this.$EventBus.$off('changeInsertStory');
            this.$EventBus.$off('changeUpdateStory');
            this.$EventBus.$off('changeDeleteStory');
            this.$EventBus.$off('changeCloseStory');
            this.$EventBus.$off('changeShowStory');
            this.$EventBus.$off('changeSearchStory');
        },
        mounted: function() {
            this.fetchStories();
        },
        methods: {
            fetchStories: function() {
                ...
                axios.get(Config.base_url+'/changenotice/liststory', {
                    params: {
                        "bbs_id" : vm.bbs_id,
            ...
            insertStory: function(story) {
                ...
                axios.post(Config.base_url+'/changenotice/insertstory', {
                    "bbs_id"   : this.bbs_id,
                    "storyinfo": story
                }).then(function(response) {
                    // console.log(response);
            ...
            updateStory: function(story) {
                ...
                axios.post(Config.base_url+'/changenotice/updatestory', {
                    "bbs_id"   : this.bbs_id,
                    "storyinfo": story
                }).then(function(response) {
                    // console.log(response);
            ...
            deleteStory: function(story) {
                ...
                axios.post(Config.base_url+'/changenotice/deletestory', {
                    "bbs_id"   : this.bbs_id,
                    "storyinfo": story
                }).then(function(response) {
                    // console.log(response);
            ...
            updateViewCount: function(story){
                ...
                axios.post(Config.base_url+'/changenotice/updateviewcount', {
                    "bbs_id"   : this.bbs_id,
