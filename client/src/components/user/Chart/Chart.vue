            ...
            <form novalidate @submit.stop.prevent>
                <div class="form-inline">
                 ...
                 <div class="form-group tar">
					...
					<button type="submit" @click="downloadFileTerm" class="btn btn-basic col-md-2">전체다운로드</button>
				</div>    
            </form>
            <div class="logo">
                <i class="fas fa-align-justify"></i><span> {{ comp_name }} 보안 관제 일간 보고서</span>
                <br>
                <br>
            </div>
            <ul class="list-group">
...
import UserSpecInfo from "./UserSpecInfo.vue"
...
export default {
    ...
    methods: {
        ...
        fetchChartListTerm: function () {
            var vm = this;
            axios.post(Config.base_url+'/user/chart/chartlistterm',{
                "sdate" : this.sdate,
                "edate": this.edate,
        ...
        downloadFileTerm: function () {
            ...
            axios.post(Config.base_url+'/user/chart/downloadfileterm',{
                "sdate": this.sdate,
                "edate": this.edate,
                "comp_no": this.comp_no,
            }).then(function (response) {
